...
class CounterScreen extends NavScreen {
  ...
  const CounterScreen(NavAwareState navState)
      : super(screenTitle: "Counter", tabIndex: navTabIndex, navState: navState);

  static final counterKey = GlobalKey<_CounterWidgetState>();
...
class CounterWidget extends StatefulWidget {
  const CounterWidget({required Key? key}) : super(key: key);
...
class _CounterWidgetState extends State<CounterWidget> with RestorationMixin {
  ...
  @override
  String? get restorationId => "counter-screen";
